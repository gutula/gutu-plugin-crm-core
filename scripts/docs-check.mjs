...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/crm-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-crm-core:");
...
console.log("Documentation check passed for gutu-plugin-crm-core.");
