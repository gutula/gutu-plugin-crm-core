...
- Package root: `framework/builtin-plugins/crm-core`
- Service layer: `framework/builtin-plugins/crm-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/crm-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/crm-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/crm-core/src/ui`

## Safe assumptions

- Use `crm-core` as the stable plugin identifier and `@plugins/crm-core` as the package import name.
