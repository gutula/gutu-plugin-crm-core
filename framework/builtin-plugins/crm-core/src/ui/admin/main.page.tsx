...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "CRM Control Room"),
    React.createElement("p", null, "Lead capture, opportunity posture, and governed handoff readiness into quote and order flows."),
    React.createElement(
      "p",
      null,
